...
class Cli {
  // vehicles should be able to hold Cars, Trucks, and Motorbikes
  ...
  // Choose a vehicle from existing vehicles
  chooseVehicle(): void {
    inquirer
      .prompt([
        {
  ...
  // Create a vehicle (Car, Truck, or Motorbike)
  createVehicle(): void {
    inquirer
      .prompt([
        {
  ...
  // Perform actions based on the vehicle type
  performActions(): void {
    inquirer
      .prompt([
        {
          ...
          choices: [
            ...
            'Turn left',
            'Reverse',
            'Tow vehicle', // Action to tow a vehicle
            'Wheelie',      // Action to perform a wheelie (only for motorbikes)
  ...
  // Find a vehicle to tow (only for Trucks)
